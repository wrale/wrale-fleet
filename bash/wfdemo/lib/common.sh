...
# wfcentral: 8600-8699 
# wfdevice:  8700-8799
export WFCENTRAL_API_PORT=8600       # Main API for device management
export WFCENTRAL_MGMT_PORT=8601      # Health and management endpoints
export WFDEVICE_API_PORT=8700        # Device agent API
export WFDEVICE_MGMT_PORT=8701       # Device health endpoints
